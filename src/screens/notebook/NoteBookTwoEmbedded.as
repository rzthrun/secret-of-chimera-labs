package screens.notebook
{
	...
	public class NoteBookTwoEmbedded extends Sprite
	{
		...
		public function NoteBookTwoEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/HUD/NoteBook/NoteBook_Sprite_02.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/HUD/NoteBook/NoteBook_Sprite_02.xml'));
