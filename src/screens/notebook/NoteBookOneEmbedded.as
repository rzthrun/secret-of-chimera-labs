package screens.notebook
{
	...
	public class NoteBookOneEmbedded extends Sprite
	{
		...
		public function NoteBookOneEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/HUD/NoteBook/NoteBook_Sprite_01.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/HUD/NoteBook/NoteBook_Sprite_01.xml'));
