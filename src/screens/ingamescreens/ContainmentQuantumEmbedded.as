package screens.ingamescreens
{
	...
	public class ContainmentQuantumEmbedded extends Sprite
	{
		...
		public function ContainmentQuantumEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/ContainmentQuantum/ContainmentQuantum_Sprite_01.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/ContainmentQuantum/ContainmentQuantum_Sprite_01.xml'));
