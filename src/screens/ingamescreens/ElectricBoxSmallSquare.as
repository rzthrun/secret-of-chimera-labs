package screens.ingamescreens
{
	...
	public class ElectricBoxSmallSquare extends Sprite
	{
		...
		public function ElectricBoxSmallSquare(_assets:AssetManager,_type:String,_x:Number,_y:Number,
										  //  n_l:String,
										  //  n_t:String,
										  //  n_r:String,
										  //  n_b:String,
		...
		private function onLoadAssets():void{
			...
			SourceImage.x = __x;
			SourceImage.y = __y;
			SourceImage.pivotX = 56;
			SourceImage.pivotY = 56;
			//	s
			trace("MY POS is: "+pos);
			//		if(pos == '0'){
