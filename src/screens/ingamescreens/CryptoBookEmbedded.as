package screens.ingamescreens
{
	...
	public class CryptoBookEmbedded extends Sprite
	{
		...
		public function CryptoBookEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/RocketRoomDesk/CryptoBook_Sprite.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/RocketRoomDesk/CryptoBook_Sprite.xml'));
