package screens.ingamescreens
{
	...
	public class DeepLabDeskEmbedded extends Sprite
	{
		...
		public function DeepLabDeskEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/DeepLabDesk/DnaBook_Sprite_01.png'));
