package screens.ingamescreens
{
	...
	public class ContainmentInteriorEmbedded extends Sprite
	{
		...
		public function ContainmentInteriorEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/ContainmentInterior/ContainmentInterior_Sprite_01.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/ContainmentInterior/ContainmentInterior_Sprite_01.xml'));
