package starling.display
{
	...
	//		trace("Begin Fill");
		...
		public function endFill(nullFill:Boolean = true):void
		{
			_fillStyleSet 	= false;
			_fillColor 		= NaN;
			_fillAlpha 		= NaN;
		...
		//	trace("_currentFill "+_currentFill);
			return _currentFill.shapeHitTest(stageX, stageY);
		}
